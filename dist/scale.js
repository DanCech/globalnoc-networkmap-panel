                ...
                _createClass(Scale, [{
                    ...
                    value: function getThresholdColor(percentage, colors, thresholds) {
                        ...
                        _.forEach(thresholds, function (el) {
                            return threshold_arr.push(parseInt(el));
                        });
